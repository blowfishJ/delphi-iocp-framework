...
uses
  Windows, SysUtils, SyncObjs, System.Generics.Collections, IocpLogger;

type
  TIocpMemoryPool = class
  private
    type
      TMemBlockStack = TStack<Pointer>;
      TMemBlockList = TList<Pointer>;
  private
    FRefCount: Integer;
    ...
    FFreeMemoryBlockList: TMemBlockStack;
    FUsedMemoryBlockList: TMemBlockList;
  ...
  public
    ...
    property FreeMemoryBlockList: TMemBlockStack read FFreeMemoryBlockList;
    property UsedMemoryBlockList: TMemBlockList read FUsedMemoryBlockList;
...
begin
  ...
  FFreeMemoryBlockList := TMemBlockStack.Create;
  FUsedMemoryBlockList := TMemBlockList.Create;
...
begin
  ...
  try
    ...
    begin
      Result := FFreeMemoryBlockList.Pop;
