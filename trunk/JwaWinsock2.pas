...
function connect(s: TSocket; name: PSockAddr; namelen: Integer): Integer;
  stdcall;
{$EXTERNALSYM connect}
function ioctlsocket(s: TSocket; cmd: u_long; var argp: u_long): Integer;
  stdcall;
{$EXTERNALSYM ioctlsocket}
function getpeername(s: TSocket; name: PSockAddr; var namelen: Integer):
  Integer; stdcall;
{$EXTERNALSYM getpeername}
function getsockname(s: TSocket; name: PSockAddr; var namelen: Integer):
  Integer; stdcall;
{$EXTERNALSYM getsockname}
function getsockopt(s: TSocket; level, optname: Integer; optval: PAnsiChar; var
...
{$EXTERNALSYM recv}
function recvfrom(s: TSocket; var buf; len, flags: Integer; from: PSockAddr; var
...
{$EXTERNALSYM send}
function sendto(s: TSocket; var buf; len, flags: Integer; toaddr: PSockAddr;
  tolen: Integer): Integer; stdcall;
{$EXTERNALSYM sendto}
function setsockopt(s: TSocket; level, optname: u_long; optval: PAnsiChar; optlen:
...
function WSAStartup(wVersionRequired: WORD; var lpWSAData: TWSAData): Integer;
  stdcall;
...
function WSAAsyncSelect(s: TSocket; hWnd: HWND; wMsg: u_int; lEvent: Longint):
  Integer; stdcall;
...
function WSAGetOverlappedResult(s: TSocket; lpOverlapped: LPWSAOVERLAPPED;
  var lpcbTransfer: DWORD; fWait: BOOL; var lpdwFlags: DWORD): BOOL; stdcall;
    // Thanks Kai Henningsen for var on lpdwFlags
{$EXTERNALSYM WSAGetOverlappedResult}
function WSAGetQOSByName(s: TSocket; var lpQOSName: WSABUF; lpQOS: LPQOS): BOOL;
  stdcall;
{$EXTERNALSYM WSAGetQOSByName}
function WSAHtonl(s: TSocket; hostlong: u_long; var lpnetlong: u_long): Integer;
  stdcall;
{$EXTERNALSYM WSAHtonl}
function WSAHtons(s: TSocket; hostshort: u_short; var lpnetshort: u_short):
  Integer; stdcall;
...
function WSAJoinLeaf(s: TSocket; name: PSockAddr; namelen: Integer;
  ...
  lpCalleeData: LPWSABUF; lpSQOS, lpGQOS: LPQOS; dwFlags: DWORD): TSocket;
    stdcall;
{$EXTERNALSYM WSAJoinLeaf}
function WSANtohl(s: TSocket; netlong: u_long; var lphostlong: u_long): Integer;
  stdcall;
{$EXTERNALSYM WSANtohl}
function WSANtohs(s: TSocket; netshort: u_short; var lphostshort: u_short):
  Integer; stdcall;
...
function WSASendTo(s: TSocket; lpBuffers: LPWSABUF; dwBufferCount: DWORD;
  var lpNumberOfBytesSent: DWORD; dwFlags: DWORD; lpTo: PSockAddr; iTolen:
    Integer;
  lpOverlapped: LPWSAOVERLAPPED; lpCompletionRoutine:
    LPWSAOVERLAPPED_COMPLETION_ROUTINE): Integer; stdcall;
...
function WSANSPIoctl(hLookup: THandle; dwControlCode: DWORD; lpvInBuffer:
  Pointer; cbInBuffer: DWORD;
  lpvOutBuffer: Pointer; cbOutBuffer: DWORD; lpcbBytesReturned: LPDWORD;
...
function WSAInstallServiceClassA(lpServiceClassInfo: LPWSASERVICECLASSINFOA):
  Integer; stdcall;
{$EXTERNALSYM WSAInstallServiceClassA}
function WSAInstallServiceClassW(lpServiceClassInfo: LPWSASERVICECLASSINFOW):
  Integer; stdcall;
{$EXTERNALSYM WSAInstallServiceClassW}
function WSAInstallServiceClass(lpServiceClassInfo: LPWSASERVICECLASSINFO):
  Integer; stdcall;
...
begin
  GetProcedureAddress(_WSAAsyncGetProtoByName, ws2_32,
...
begin
  GetProcedureAddress(_WSAAsyncGetProtoByNumber, ws2_32,
...
begin
  GetProcedureAddress(_WSADuplicateSocket, ws2_32, 'WSADuplicateSocket' +
    AWSuffix);
  asm
        MOV     ESP, EBP
        POP     EBP
...
begin
  GetProcedureAddress(_WSAGetOverlappedResult, ws2_32,
...
begin
  GetProcedureAddress(_WSAWaitForMultipleEvents, ws2_32,
...
begin
  GetProcedureAddress(_WSAAddressToString, ws2_32, 'WSAAddressToString' +
    AWSuffix);
  asm
        MOV     ESP, EBP
        POP     EBP
...
begin
  GetProcedureAddress(_WSAStringToAddress, ws2_32, 'WSAStringToAddress' +
    AWSuffix);
  asm
        MOV     ESP, EBP
        POP     EBP
...
begin
  GetProcedureAddress(_WSALookupServiceBeginA, ws2_32,
...
begin
  GetProcedureAddress(_WSALookupServiceBeginW, ws2_32,
...
begin
  GetProcedureAddress(_WSALookupServiceBegin, ws2_32, 'WSALookupServiceBegin' +
    AWSuffix);
  asm
        MOV     ESP, EBP
        POP     EBP
...
begin
  GetProcedureAddress(_WSALookupServiceNext, ws2_32, 'WSALookupServiceNext' +
    AWSuffix);
  asm
        MOV     ESP, EBP
        POP     EBP
...
begin
  GetProcedureAddress(_WSAInstallServiceClassA, ws2_32,
...
begin
  GetProcedureAddress(_WSAInstallServiceClassW, ws2_32,
...
begin
  GetProcedureAddress(_WSAInstallServiceClass, ws2_32, 'WSAInstallServiceClass'
    + AWSuffix);
  asm
        MOV     ESP, EBP
        POP     EBP
...
begin
  GetProcedureAddress(_WSAGetServiceClassInfoA, ws2_32,
...
begin
  GetProcedureAddress(_WSAGetServiceClassInfoW, ws2_32,
...
begin
  GetProcedureAddress(_WSAGetServiceClassInfo, ws2_32, 'WSAGetServiceClassInfo'
    + AWSuffix);
  asm
        MOV     ESP, EBP
        POP     EBP
...
begin
  GetProcedureAddress(_WSAEnumNameSpaceProvidersA, ws2_32,
...
begin
  GetProcedureAddress(_WSAEnumNameSpaceProvidersW, ws2_32,
...
begin
  GetProcedureAddress(_WSAEnumNameSpaceProviders, ws2_32,
...
begin
  GetProcedureAddress(_WSAGetServClassNameByClassIdA, ws2_32,
...
begin
  GetProcedureAddress(_WSAGetServClassNameByClassIdW, ws2_32,
...
begin
  GetProcedureAddress(_WSAGetServClassNameByClassId, ws2_32,
...
begin
  GetProcedureAddress(_WSAProviderConfigChange, ws2_32,
