...
uses
  ...
  Iocp.Utils, Iocp.TcpSocket, Iocp.VariantPacket, Iocp.VariantSocket, Iocp.Logger;
...
type
  TTestIocpServer = class(TIocpVariantServer)
  protected
...
procedure TTestIocpServer.DoOnRequest(Client: TIocpVariantServerConnection;
  Request, Response: TIocpVariantPacket);
begin
  Response.Params['back'] := 'I am OK, dont worry';
end;
