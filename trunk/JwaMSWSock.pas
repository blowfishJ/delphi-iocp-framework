...
function WSARecvEx(s: TSocket; buf: PAnsiChar; len: Integer; var flags: Integer):
  Integer; stdcall;
...
function TransmitFile(hSocket: TSocket; hFile: THandle; nNumberOfBytesToWrite,
  nNumberOfBytesPerSend: DWORD; lpOverlapped: POVERLAPPED;
  lpTransmitBuffers: LPTRANSMIT_FILE_BUFFERS; dwReserved: DWORD): BOOL; stdcall;
{$EXTERNALSYM TransmitFile}

function AcceptEx(sListenSocket, sAcceptSocket: TSocket; lpOutputBuffer:
  Pointer;
...
type
  LPFN_TRANSMITFILE = function(hSocket: TSocket; hFile: THandle;
    ...
    nNumberOfBytesPerSend: DWORD; lpOverlapped: POVERLAPPED;
    lpTransmitBuffers: LPTRANSMIT_FILE_BUFFERS; dwReserved: DWORD): BOOL;
      stdcall;
...
const
  WSAID_TRANSMITFILE: TGUID = (
    D1: $B5367DF0; D2: $CBAC; D3: $11CF; D4: ($95, $CA, $00, $80, $5F, $48, $A1,
      $92));
...
const
  WSAID_TRANSMITPACKETS: TGUID = (
    D1: $D9689DA0; D2: $1F90; D3: $11D3; D4: ($99, $71, $00, $C0, $4F, $68, $C8,
      $76));
...
const
  WSAID_CONNECTEX: TGUID = (
    D1: $25A207B9; D2: $DDF3; D3: $4660; D4: ($8E, $E9, $76, $E5, $8C, $74, $06,
      $3E));
{$EXTERNALSYM WSAID_CONNECTEX}

type
  LPFN_DISCONNECTEX = function(s: TSocket; lpOverlapped: POVERLAPPED; dwFlags:
    DWORD; dwReserved: DWORD): BOOL; stdcall;
{$EXTERNALSYM LPFN_DISCONNECTEX}

const
  WSAID_DISCONNECTEX: TGUID = (
    D1: $7FDA2E11; D2: $8630; D3: $436F; D4: ($A0, $31, $F5, $36, $A6, $EE, $C1,
      $57));
...
{$EXTERNALSYM DE_REUSE_SOCKET}
  ...
  NLA_NAMESPACE_GUID: TGUID = (
    D1: $6642243A; D2: $3BA8; D3: $4AA6; D4: ($BA, $A5, $2E, $0B, $D7, $1F, $DD,
      $83));
{$EXTERNALSYM NLA_NAMESPACE_GUID}
  ...
  NLA_SERVICE_CLASS_GUID: TGUID = (
    D1: $37E515; D2: $B5C9; D3: $4A43; D4: ($BA, $DA, $8B, $48, $A8, $7A, $D2,
      $39));
...
const
  WSAID_WSARECVMSG: TGUID = (
    D1: $F689D7C8; D2: $6F1F; D3: $436B; D4: ($8A, $53, $E5, $4F, $E3, $51, $C3,
      $22));
...
begin
  GetProcedureAddress(_GetAcceptExSockaddrs, mswsocklib,
